    ...
    <>
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-800 bg-opacity-50">
          <div className="bg-[var(--sections)] rounded-lg w-3/4 max-w-3xl p-6 overflow-y-auto h-[90%]">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-white">Terms of Service for Nerdd Nest</h2>
              <button onClick={closeModal} className="text-gray-400 hover:text-black">
                <FiX size={20} />
              </button>
            </div>
            <p className="text-sm mb-2">Effective Date: 10/28/24</p>
            <p className="mb-4">
            ...
            <ol className="list-decimal pl-6 space-y-4 text-sm leading-7">
              <li>
                <strong className="text-white">Acceptance of Terms</strong>
              ...
              <li>
                <strong className="text-white">User Accounts and Responsibilities</strong>
              ...
              <li>
                <strong className="text-white">Content and Conduct</strong>
