        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-800 bg-opacity-50">
          <div className="bg-white rounded-lg w-3/4 max-w-3xl p-6 overflow-y-auto h-[90%]">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Terms of Service for Nerdd Nest</h2>
            ...
            <ol className="list-decimal pl-6 space-y-4 text-sm text-gray-600">
              <li>
              ...
              <li>
                <strong>3. User Accounts and Responsibilities</strong>
